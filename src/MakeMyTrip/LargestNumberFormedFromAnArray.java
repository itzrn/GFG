package src.MakeMyTrip;

/**
 * Given an array of strings arr[] of length n representing non-negative integers,
 * arrange them in a manner, such that, after concatanating them in order, it results in the largest possible number.
 ...
 * which takes the array of strings arr[] as a parameter and returns a string denoting the answer.
 *
...
public class LargestNumberFormedFromAnArray {
    String printLargest(int n, String[] arr) {
        // sorting the array after merging two elements and picking greatest, means arranging in descending order
        Arrays.sort(arr, (x, y)->{ // lambda expression
            String xy = x+y;
            String yx = y+x;
